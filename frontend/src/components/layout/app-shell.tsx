...
export function AppShell({ children, noPadding }: AppShellProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0 lg:ml-60">
        ...
        <main className="flex-1 overflow-hidden flex flex-col min-h-0" data-lenis-prevent>
          {noPadding ? (
            <PageTransition className="h-full flex flex-col flex-1 min-h-0 overflow-hidden">{children}</PageTransition>
          ) : (
