...
FY2025_26 = IndiaFiscalYearConstants(
    ...
    new_slabs=(
        TaxSlab(lower=0, upper=4_00_000, rate=0.00),
        TaxSlab(lower=4_00_000, upper=8_00_000, rate=0.05),
        TaxSlab(lower=8_00_000, upper=12_00_000, rate=0.10),
        TaxSlab(lower=12_00_000, upper=16_00_000, rate=0.15),
        TaxSlab(lower=16_00_000, upper=20_00_000, rate=0.20),
        TaxSlab(lower=20_00_000, upper=24_00_000, rate=0.25),
        TaxSlab(lower=24_00_000, upper=float("inf"), rate=0.30),
    ),
    new_rebate_limit=12_00_000,
    new_rebate_max=60_000,
